...
///////////////////////////////////////////////////////////////////////////////
	...
	public FirebaseResponse getLimit(String path, String start, String end) throws FirebaseException {
		// make the request
		String url = this.buildFullUrlFromRelativePath(path) + "?startAt=" + start +
				"&endAt=" + end;
		HttpGet request = new HttpGet( url );
		HttpResponse httpResponse = this.makeRequest( request );
